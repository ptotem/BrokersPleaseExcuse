...
Labelling.create!(:name=>'ASS')
Labelling.create!(:name=>'ASS +')
Labelling.create!(:name=>'ASS >')
Labelling.create!(:name=>'ASS ?')
Labelling.create!(:name=>'ASS >>')
Labelling.create!(:name=>'ASSF')
Labelling.create!(:name=>'LLP')
Labelling.create!(:name=>'LLC')
Labelling.create!(:name=>'LLF')
Labelling.create!(:name=>'LL ?')
Labelling.create!(:name=>'LL >>')
Labelling.create!(:name=>'Reference')
Labelling.create!(:name=>'Tenant')
Labelling.create!(:name=>'Landlord')
...
Labelling.create!(:name=>'Important')
Labelling.create!(:name=>'Regular')
Labelling.create!(:name=>'Revisit')
Labelling.create!(:name=>'Demanding')
